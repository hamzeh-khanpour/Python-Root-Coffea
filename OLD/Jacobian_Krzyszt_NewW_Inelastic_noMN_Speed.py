    ...
    def integrand(ye):
        ...
        def lnQ2e_integrand(lnQ2e):
            ...
            def integrand_MN(MN):
                ...
                return integrate.quad_vec(lnQ2p_integrand, lnQ2p_min, lnQ2p_max, epsrel=1e-4)[0]

            return integrate.quad_vec(integrand_MN, MN_min, MN_max, epsrel=1e-4)[0] * flux_y_electron(ye, lnQ2e)

        return integrate.quad_vec(lnQ2e_integrand, lnQ2e_min, lnQ2e_max, epsrel=1e-4)[0]
...
if __name__ == "__main__":
    ...
    # Using Pool.starmap() for flexibility in passing multiple parameters if needed
    ...
    plt.savefig("Jacobian_Krzysztof_Inelastic_Updated_noMN_Speed.pdf")
    plt.savefig("Jacobian_Krzysztof_Inelastic_Updated_noMN_Speed.jpg")
    plt.show()
