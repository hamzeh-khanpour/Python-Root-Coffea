...
plt.title("Rapidity distribution at LHeC", fontsize=20)
plt.grid(True, which="both", linestyle="--")
plt.legend(title=r'$Q^2_e < 10^5 \, \mathrm{GeV}^2, \, Q^2_p < 10^5 \, \mathrm{GeV}^2$', fontsize=14)

# Save the plot
plt.savefig("differential_cross_section_rapidity.pdf")
plt.savefig("differential_cross_section_rapidity.jpg")
