...
def flux_y_inel(yp, mMin2, qmax2, mNmax):
    ...
    try:
        ...
        result_1, _ = integrate.quad(integrand, math.log(qmin2v), mid_lnQ2, epsrel=1e-4)
        result_2, _ = integrate.quad(integrand, mid_lnQ2, math.log(qmax2), epsrel=1e-4)
...
W_value = 10.0  # GeV
elasticluminosity_at_W10 = flux_el_yy_atW(W_value, eEbeam, pEbeam, q2emax, q2pmax)
print(f"Elastic Photon-Photon Luminosity Spectrum at W = {W_value} GeV: {elasticluminosity_at_W10:.6e} GeV^-1")


inelasticluminosity_at_W10 = flux_inel_yy_atW(W_value, eEbeam, pEbeam, q2emax, q2pmax, mNmax)
print(f"Elastic Photon-Photon Luminosity Spectrum at W = {W_value} GeV: {inelasticluminosity_at_W10:.6e} GeV^-1")
...
# Plot Elastic and Inelastic Luminosity Spectra
