# Elastic Photon-Photon Luminosity Spectrum at LHeC --- Updated Version with Monte Carlo Integration and Parallel Computing
...
def wrapper_flux_el_yy_atW(W):
    return flux_el_yy_atW_monte_carlo(W, eEbeam, pEbeam)

# Parallel Calculation of the Elastic Photon-Photon Luminosity Spectrum using Monte Carlo Integration
