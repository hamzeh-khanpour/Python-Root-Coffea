...
plt.savefig("elastic_photon_luminosity_spectrum_with_NewS.pdf")
plt.savefig("elastic_photon_luminosity_spectrum_with_NewS.jpg")
...
# Save the plot as a PDF
plt.savefig("integrated_tau_tau_cross_section_with_NewS.pdf")
plt.savefig("integrated_tau_tau_cross_section_with_NewS.jpg")  
