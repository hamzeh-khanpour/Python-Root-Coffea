...
W_krzysztof, Syy_krzysztof = np.loadtxt("Jacobian_Krzysztof.txt", skiprows=1, unpack=True)
...
plt.loglog(W_krzysztof, Syy_krzysztof, 'b--', label="Corrected W", linewidth=2)
...
plt.text(W_value, Syy_krzysztof_value, f"Syy with Corrected W at 10 GeV =  {Syy_krzysztof_value:.2e}", color='blue', fontsize=12, ha='left', va='top')
...
plt.savefig("Comparison_Luminosity_Spectrum.pdf")
plt.savefig("Comparison_Luminosity_Spectrum.jpg")
...
plt.title("Relative Difference between Old W and Corrected W", fontsize=20)
plt.grid(True, which="both", linestyle="--")
plt.legend(title=r'$Q^2_e < 10^5 \, \mathrm{GeV}^2, \, Q^2_p < 10^1 \, \mathrm{GeV}^2$', fontsize=14)
...
plt.savefig("Relative_Difference.jpg")
