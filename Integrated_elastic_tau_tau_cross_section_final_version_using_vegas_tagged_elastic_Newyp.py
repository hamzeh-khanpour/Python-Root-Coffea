...
#  Hamzeh Khanpour, Laurent Forthomme, and Krzysztof Piotrzkowski -- January 2025 -- tagged elastic
...
def flux_y_proton(yp):
    if yp <= 0.01 or yp >= 0.10:                                 # Hamzeh tagged elastic   ==>  if (yp <= 0.01 or yp >= 0.10):
...
if __name__ == "__main__":
    ...
    filename_txt = f"Elastic_Photon_Luminosity_Spectrum_q2emax_{int(q2emax)}_q2pmax_{int(q2pmax)}_using_vegas_tagged_elastic_Newyp.txt"
