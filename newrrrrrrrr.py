...
if __name__ == "__main__":
    ...
    plt.legend(title=r'$Q^2_{e,\text{max}} = 10 \, \mathrm{GeV}^2, \, Q^2_{p,\text{max}} = 10 \, \mathrm{GeV}^2$', fontsize=14)
