...
W_krzysztof, Syy_krzysztof = np.loadtxt("Jacobian_Krzysztof_NewW.txt", skiprows=1, unpack=True)
...
plt.loglog(W_krzysztof, Syy_krzysztof, 'b--', label="W^2 = -Qe2 + ye yp s", linewidth=2)
...
plt.text(W_value, Syy_krzysztof_value, f"Syy with (-Qe2 + ye yp s) at 10 GeV =  {Syy_krzysztof_value:.2e}", color='blue', fontsize=12, ha='left', va='top')


# Add additional information to the plot
plt.xlabel(r"$W$ [GeV]", fontsize=18)
plt.ylabel(r"$S_{\gamma\gamma}$ [GeV$^{-1}$]", fontsize=18)
plt.title("Comparison of (ye yp s) and (-Qe2 + ye yp s)", fontsize=20)
plt.grid(True, which="both", linestyle="--")
plt.legend(title=r'$Q^2_e < 10^5 \, \mathrm{GeV}^2, \, Q^2_p < 10^5 \, \mathrm{GeV}^2$', fontsize=14)

# Save the plot as a PDF and JPG
plt.savefig("Comparison_Luminosity_Spectrum_NewW.pdf")
plt.savefig("Comparison_Luminosity_Spectrum_NewW.jpg")
...
plt.title("Relative Difference between (ye yp s) and (-Qe2 + ye yp s)", fontsize=20)
plt.grid(True, which="both", linestyle="--")
plt.legend(title=r'$Q^2_e < 10^5 \, \mathrm{GeV}^2, \, Q^2_p < 10^5 \, \mathrm{GeV}^2$', fontsize=14)


# Save the plot as a PDF and JPG
plt.savefig("Relative_Difference_NewW.pdf")
plt.savefig("Relative_Difference_NewW.jpg")
